...
def main():
    ...
    plt.subplot(131)
    plt.plot(U.real,-z,label='Re U')
    plt.plot(U.imag,-z,label='Im U')
    plt.ylabel("depth,km")
    plt.legend()

    plt.subplot(132)
    plt.plot(W.real,-z,label='Re W')
    plt.plot(W.imag,-z,label='Im W')
    #plt.ylabel("depth,km")
    plt.legend()

    plt.subplot(133)
    plt.plot(V.real,-z,label='Re V')
    plt.plot(V.imag,-z,label='Im V')
    #plt.ylabel("depth,km")
    plt.legend()
